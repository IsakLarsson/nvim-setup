...
_G.packer_plugins = {
  ...
  ["minimap.vim"] = {
    loaded = true,
    path = "/Users/isakamanlarsson/.local/share/nvim/site/pack/packer/start/minimap.vim",
  ...
  ["vim-be-good"] = {
    loaded = true,
    path = "/Users/isakamanlarsson/.local/share/nvim/site/pack/packer/start/vim-be-good",
